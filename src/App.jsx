...
export default function LaunchPathAI() {
  ...
  const handleLogout = async () => {
    if (user !== 'guest') await supabase.auth.signOut();
    setUser(null);
    setMessages([]);
    setShowAuthModal(true);
  };
  ...
  if (checkingAuth) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div style={{ backgroundColor: '#000', width: '64px', height: '64px', borderRadius: '16px',
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      {showAuthModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          maxWidth: '400px', width: '100%', boxShadow: '0 25px 50px rgba(0,0,0,0.25)' }}>
            <div className="text-center mb-8">
              <div style={{ backgroundColor: '#000', width: '64px', height: '64px',
              borderRadius: '16px', display: 'flex', alignItems: 'center',
              justifyContent: 'center', margin: '0 auto 16px' }}>
                <RocketIcon className="w-8 h-8 text-white" />
              </div>

              <h2 style={{ fontSize: '28px', fontWeight: '900', color: '#000', marginBottom: '8px' }}>
            ...
            <div className="space-y-3">
              <button
                ...
                style={{ width: '100%', padding: '14px 20px', backgroundColor: 'white',
                border: '2px solid #E5E7EB', borderRadius: '12px', fontSize: '16px',
                fontWeight: '600', color: '#1F2937', cursor: 'pointer',
              ...
              <button
                ...
                style={{ width: '100%', padding: '14px 20px', backgroundColor: '#000',
      ...
      <header className="bg-white border-b-4 border-black px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div style={{ backgroundColor: '#000', width: '48px', height: '48px', borderRadius: '12px',
            display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div className="flex items-center gap-4">
            ...
            {user && (
              <button
                ...
                style={{ backgroundColor: '#F3F4F6', padding: '8px 12px', borderRadius: '8px',
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-6 flex flex-col">
        ...
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            <div style={{ backgroundColor: '#000', width: '96px', height: '96px',
            ...
            <h1 style={{ fontSize: '36px', fontWeight: '900', color: '#000',
            marginBottom: '12px' }}>
              LaunchPath
            </h1>
            ...
            marginBottom: '32px', maxWidth: '450px' }}>
              Your AI assistant for everything — with expertise in business, finance & investing
            </p>
              ...
              <div key={idx} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                ...
                <div
                  style={{
                    ...
                    padding: "12px 20px",
                    borderRadius: "16px",
                    backgroundColor: msg.role === "user" ? "#000" : "white",
                    color: msg.role === "user" ? "white" : "#1F2937",
                    border: msg.role === "user" ? "none" : "3px solid #E5E7EB",
                    fontWeight: "500",
                  }}
                >
